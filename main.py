...
html_title = """
    ...
    <center><h1 class="title-text">Adidas Interactive Sales Dashboards</h1></center>"""
...
with col4:
    fig = px.bar(df, x="Retailer",y="Total Sales",labels={"TotalSales":"Total Sales {$}"},
...
html_footer = """
    ...
    <center>
    <h2 class="footer-text"><p>Developed with ❤️ by <a href="https://www.linkedin.com/in/pranavpurankar/">Pranav Purankar </p>
    </h2>
    </center>
    <center>
